...
duration: 15 minuets
# nuke has a theme: "reveal-md/nuke-theme.css", alternatively, you can use a named default like "night" from this list: https://github.com/hakimel/reveal.js/tree/master/css/theme/source
# Add custom css files for your slides here, comma separated:
separator: "\r?\n---\r?\n"
verticalSeparator: "\r?\n---v\r?\n"
# Below can be any of these: https://revealjs.com/config/
revealOptions:
  theme: reveal-md/base-theme.css
...
License: <https://support.giphy.com/hc/en-us/articles/360020027752-GIPHY-User-Terms-of-Service>
